...
const TERMINAL_FONT_SIZE := 16  # Terminus bitmap font (native 8x16)
const CELL_WIDTH := 8   # Terminus at 16pt: 8px wide
const CELL_HEIGHT := 16  # Terminus at 16pt: 16px tall
